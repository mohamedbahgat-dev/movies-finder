               ...
               <div className=' flex items-center absolute top-28 left-10 text-white max-[650px]:flex-col max-[650px]:w-72 max-[650px]:h-64 md:left-2'>
                    ...
                    <div className='ml-10 relative max-[650px]:ml-44 max-[650px]:mt-12  sm:mt-8 md:mt-16'> 
                      ...
                      <div className='flex items-center mt-8'>
                          ...
                          <div className='bg-teal-600 p-2 mr-3 rounded-full' onClick={handleMovieList} onMouseOver={showMylist} onMouseLeave={hideMylist}>
                          ...
                          <div className='bg-teal-600 p-2 mr-3 rounded-full' onClick={handleFavorites} onMouseOver={showFavorites} onMouseLeave={hideFavorites}>
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5">
                          ...
                          <div className='bg-teal-600 p-2 mr-3 rounded-full' onClick={handleWatchList} onMouseOver={showWatchlist} onMouseLeave={hideWatchlist}>
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5">
